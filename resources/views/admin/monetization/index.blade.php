<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200">{{ __('Monetization') }}</h2>
    </x-slot>
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
                ...
                <p class="text-sm mt-2 {{ $paystackConfigured ? 'text-green-600 dark:text-green-400' : 'text-amber-600 dark:text-amber-400' }}">
