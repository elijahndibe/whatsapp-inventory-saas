<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200">{{ __('Businesses') }}</h2>
    </x-slot>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach ($businesses as $business)
                            <tr>
                                ...
                                <td class="px-4 py-3">
                                    <span @class(['inline-flex px-2 py-0.5 rounded-full text-xs font-medium', 'bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300' => $business->status === 'active', 'bg-red-100 text-red-800 dark:bg-red-900/40 dark:text-red-300' => $business->status !== 'active'])>
